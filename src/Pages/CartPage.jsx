...
const CartPage = () => {
  ...
  const navigate = useNavigate();
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center mt-[7rem]" id="ct2">
            ...
            {cart.length === 0 ? (
                ...
                <div className="w-full max-w-2xl " id="car1">
                    {cart.map((product, index) => (
                        <div key={index} className="border p-4 mb-4 rounded-lg shadow-md flex items-center justify-between">
                            ...
                            <button
                                className="bg-red-600 text-white px-3 py-1 rounded-lg hover:bg-red-700" id="rem"
